									...
									<div class="row">
										<div class="col-12">
										  <div class="form-group">
                                            ...
                                            <div class="input-group" id="show_hide_password_oldpassword">
                                                <input type="password" name="oldpassword" class="form-control" placeholder="<?php echo e(trans('labels.old_password')); ?>" value="<?php echo e(old('oldpassword')); ?>" >
...
unset($__errorArgs, $__bag); ?>
										...
										<div class="col-12">
											<div class="form-group">
                                                ...
                                                <div class="input-group" id="show_hide_password_newpassword">
                                                    <input type="password" name="newpassword" class="form-control" placeholder="<?php echo e(trans('labels.new_password')); ?>" value="<?php echo e(old('newpassword')); ?>" >
                                                    <div class="input-group-addon toggle-password">
                                                        <a href=""><i class="fa fa-eye-slash"></i></a>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
										...
										<div class="col-12">
											<div class="form-group">
                                                ...
                                                <div class="input-group" id="show_hide_password_confirm_password">
                                                    <input type="password" name="confirmpassword" class="form-control" placeholder="<?php echo e(trans('labels.confirm_password')); ?>" value="<?php echo e(old('confirmpassword')); ?>" >
                                                    <div class="input-group-addon toggle-password">
                                                        <a href=""><i class="fa fa-eye-slash"></i></a>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Front/account.blade.php ENDPATH**/ ?>