<?php $__env->startSection('title'); ?>
    <?php echo e(Helper::webinfo()->site_title); ?> | <?php echo e(trans('labels.brands')); ?>
		...
		<div class="container">
			<nav aria-label="breadcrumb" class="simple_breadcrumbs">
			  <ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page"><?php echo e(trans('labels.brands')); ?></li>
			  </ol>
			</nav>
		</div>
	</div>
						...
						<div class="col-lg-12 col-md-12">
							<div class="toolbar toolbar-products">
								<div class="toolbar-sorter sorter">
									<input type="hidden" name="brand" id="brand" value="<?php echo e(@$products[0]->brand); ?>">
									<label class="sorter-label" for="sorter"><?php echo e(trans('labels.sort_by')); ?></label>
									<select id="sorter" data-role="sorter" class="sorter-options">
										<option value="new" data-type="brand"><?php echo e(trans('labels.new_arrivals')); ?></option>
										<option value="price-high-to-low" data-type="brand"><?php echo e(trans('labels.p_high_to_low')); ?></option>
										<option value="price-low-to-high" data-type="brand"><?php echo e(trans('labels.p_low_to_high')); ?></option>
										<option value="ratting-high-to-low" data-type="brand"><?php echo e(trans('labels.r_high_to_low')); ?></option>
										<option value="ratting-low-to-high" data-type="brand"><?php echo e(trans('labels.r_low_to_high')); ?></option>
									</select>
								</div>
							</div>
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eglobalm/public_html/resources/views/Front/brands.blade.php ENDPATH**/ ?>