            ...
            <?php if(count($cart) <= 0): ?>
                <div class="col-lg-12 col-md-12 text-center">
                    ...
                    <?php if(Auth::user()): ?>
                        ...
                        <p><span class="text-primary"><?php echo e(trans('labels.woops')); ?></span>
                            <?php echo e(trans('labels.empty_cart_text')); ?></p>
                        ...
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="tbl_cart_product">
                                                    <div class="tbl_cart_product_thumb">
                                                        <img src="<?php echo e($cartitems->image_url); ?>" class="img-fluid"
                                                            alt="" />
                                                    </div>
                                                    <div class="tbl_cart_product_caption">
                                                        <h5 class="tbl_pr_title"><a
                                                                href="<?php echo e(URL::to('products/product-details/' . $cartitems->slug)); ?>">
                                                                <?php echo e($cartitems->product_name); ?> </a></h5>
                                                        <?php if($cartitems->attribute != ''): ?>
                                                            <span
                                                                class="tbl_pr_quality theme-cl"><?php echo e($cartitems->attribute); ?>

                                                                : <?php echo e($cartitems->variation); ?></span>
                                                        <?php endif; ?>
                                                        <br>
                                            ...
                                            <td>
                                                <div class="pro-add">
                                                    <div class="value-button sub" id="decrease"
                                                        onclick="qtyupdate('<?php echo e($cartitems->id); ?>','decreaseValue')"
                                                        value="Decrease Value">
                                                        <i class="fa fa-minus-circle"></i>
                                                    </div>
                                                    <input type="number" id="number_<?php echo e($cartitems->id); ?>" name="number"
                                                        value="<?php echo e($cartitems->qty); ?>" readonly="" min="1"
                                                        max="10" />
                                                    <div class="value-button add" id="increase"
                                                        onclick="qtyupdate('<?php echo e($cartitems->id); ?>','increase')"
                                            ...
                                            <td>
                                                <h4 class="tbl_org_price">
                                                    <?php
                                                        $ttl = $cartitems->price * $cartitems->qty;
                                                        $final_sub_total += $ttl;
                                                    ?>
                                            ...
                                            <td>
                                                <div class="tbl_pr_action">
                                                    <a href="#" class="tbl_remove"
                                                        onclick="DeleteItem('<?php echo e($cartitems->id); ?>','1')"><i
                            ...
                            <div class="col-md-4 col-12 float-right">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><?php echo e(trans('labels.sub_total')); ?> <span
                                            class="float-right"><?php echo e(Helper::CurrencyFormatter($sub_total)); ?></span></li>
                                    <li class="list-group-item"><?php echo e(trans('labels.tax')); ?> <span
                                            class="float-right"><?php echo e(Helper::CurrencyFormatter($tax)); ?></span></li>
                                    <li class="list-group-item"><?php echo e(trans('labels.shipping')); ?> <span
                                            class="float-right"><?php echo e(Helper::CurrencyFormatter($shipping_cost)); ?></span></li>
                                    <li class="list-group-item"><?php echo e(trans('labels.discount')); ?> <span class="float-right">-
                                            <?php echo e(Helper::CurrencyFormatter($dis_amount)); ?></span></li>

                                    <?php if(Storage::disk('local')->has('promo')): ?>
                                        <li class="list-group-item"><strong><?php echo e(trans('labels.grand_total')); ?> <span
                                                    class="float-right"><?php echo e(Helper::CurrencyFormatter($grand_total - $dis_amount)); ?></span></strong>
                                        </li>
                                    <?php else: ?>
                                        <li class="list-group-item"><strong><?php echo e(trans('labels.grand_total')); ?> <span
                                                    class="float-right"><?php echo e(Helper::CurrencyFormatter($grand_total)); ?></span></strong>
                                        </li>
                                    <?php endif; ?>
                        ...
                        <div class="row align-items-end justify-content-between mb-10 mb-md-0">
                            <div class="col-12 col-md-6">
                                ...
                                <form class="mb-7 mb-md-0">
                                    <div class="col">
                                        <label
                                            class="font-size-sm font-weight-bold"><?php echo e(trans('labels.coupon_code')); ?></label>
                                    </div>
                                    <div class="row form-row">
                                        <div class="col">
                                            <input class="form-control form-control-sm" type="text"
                                                <?php if(@$promo['coupon_name'] != ''): ?> value="<?php echo e(@$promo['coupon_name']); ?>" readonly="" <?php endif; ?>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <?php if(@$promo['coupon_name'] == ''): ?>
                                                <button class="btn btn-dark" type="button"
                                                    onclick="applypromo()"><?php echo e(trans('labels.apply')); ?></button>
                                            <?php else: ?>
                                                <button class="btn btn-dark" type="button"
                                                    onclick="removepromo()"><?php echo e(trans('labels.remove')); ?></button>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="col-12 col-md-12 col-lg-4">
                                <a class="btn btn-dark col-lg-12"
                                    href="<?php echo e(URL::to('checkout')); ?>"><?php echo e(trans('labels.proceed_checkout')); ?></a>
                            </div>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Front/cart.blade.php ENDPATH**/ ?>