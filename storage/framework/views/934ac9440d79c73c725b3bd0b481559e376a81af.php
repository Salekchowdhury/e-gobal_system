			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-12 col-sm-12">
					...
					<div class="login_signup">
						...
						<form method="POST" action="<?php echo e(route('vendor.store_ref')); ?>">
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Front/vendor-signup-ref.blade.php ENDPATH**/ ?>