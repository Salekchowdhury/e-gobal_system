...
unset($__errorArgs, $__bag); ?>
								...
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
										...
										<input type="text"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');"  minlength="10" maxlength="10" class="form-control" name="mobile" id="mobile" value="<?php echo e(old('mobile')); ?>" placeholder="<?php echo e(trans('labels.mobile')); ?>">
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Front/vendor-signup.blade.php ENDPATH**/ ?>