                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-8">
                    ...
                    <div class="topbar_menu">
                        <ul <?php if(session()->get('locale') == 'en' OR session()->get('locale') == ''): ?> style="float: right;" <?php endif; ?>>
                            <li class="hide-m"><a href="<?php echo e(URL::to('account')); ?>"><i class="ti-user"></i><?php echo e(trans('labels.welcome')); ?> <?php echo e(Auth::user()->name); ?> </a></li>
                    ...
                    <div class="topbar_menu">
                        <ul <?php if(session()->get('locale') == 'en' OR session()->get('locale') == ''): ?> style="float: right;" <?php endif; ?>>
                            ...
                            <li><a href="<?php echo e(URL::to('signup')); ?>"><i class="ti-stamp"></i><?php echo e(trans('labels.signup')); ?></a></li>
