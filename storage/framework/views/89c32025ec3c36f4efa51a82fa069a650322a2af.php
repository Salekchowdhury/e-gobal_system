        ...
        <div class="container">
            <div class="card p-3">
                <div class="card-header">
                    <h3><?php echo e(trans('labels.edit_product')); ?></h3>
                </div>
                ...
                <form action="<?php echo e(url('admin/products/product/'.$product->id.'/update')); ?>" method="POST">
                    ...
                    <div class="row">
                         ...
                         <label>Vendor Product Price</label>
                            <input type="number" readonly name="product_price" value="<?php echo e($product->product_price); ?>" class="form-control" placeholder="Product Price...">
                         </div>
                         <div class="col-4">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/products/edit_product.blade.php ENDPATH**/ ?>