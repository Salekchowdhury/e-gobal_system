...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                        <input type="hidden" id="put_product_id"  name="product_id" value=""/>
                                        <input type="text" autocomplete="off" class="form-control" id="product_name" name="product_name" placeholder="<?php echo e(trans('placeholder.product')); ?>" value="<?php echo e(old('product_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                        <input required type="text" class="form-control" id="sku" name="sku" placeholder="<?php echo e(trans('placeholder.sku')); ?>" value="<?php echo e(old('sku')); ?>">
                                        <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                        <input required type="file" class="form-control" id="image" name="image[]" multiple="true">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                      <label for="product_type" class="col-sm-2 col-form-label"><?php echo e(trans('labels.product_type')); ?></label>
                                      <div class="col-sm-10">
                                        <select class="form-control" name="product_type" required>
                                            <option value=""> Product Type</option>
                                            <option value="own_product">Own Product </option>
                                            <option value="stockiest_product">Stockiest Product </option>
                                        </select>
...
$.ajax({
    url: "<?php echo e(route('admin.add.product.search')); ?>",
    method: 'GET',
...
$(document).on('click', '.product-id', function(e) {

   let value = $('.product-id').text();
   let product_id= $(this).val()
//   alert(product_id);

     $.ajax({
            url: "<?php echo e(route('admin.products.searchById')); ?>",
            method: 'GET',
