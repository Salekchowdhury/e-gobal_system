<table id="e-global-table1" class="table table-striped table-bordered zero-configuration">
    ...
    <tbody>
        ...
        <tr id="del-<?php echo e($row->id); ?>">
            ...
            <td>
                <a href="<?php echo e(URL::to('admin/orders/order-details/'.$row->order_number)); ?>? return_type=return && id=<?php echo e($row->order_number); ?>" class="success p-0" data-original-title="<?php echo e(trans('labels.view')); ?>" title="<?php echo e(trans('labels.view')); ?>">
...
<?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/returnorders/ordersstable.blade.php ENDPATH**/ ?>