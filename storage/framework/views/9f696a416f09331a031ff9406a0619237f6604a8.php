                    ...
                    <div class="container-fluid gradient-red-pink">
                        ...
                        <?php endif; ?>
                                ...
                                <div class="login_flex_1">
                                   <?php echo e(trans('labels.already_vendor')); ?> <a href="<?php echo e(URL::to('vendor-signup')); ?>"
                                        class="text-bold"><?php echo e(trans('labels.signin_vendor')); ?></a>
                                </div>
                                <div class="login_flex_2">
                                    <a href="<?php echo e(URL::to('forgot-password-vendor')); ?>"
                                        class="text-bold"><?php echo e(trans('labels.vendor_retrive_pass')); ?></a>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/auth/login.blade.php ENDPATH**/ ?>