                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <div class="px-3">
                                <form class="form" method="post" action="<?php echo e(route('admin.vendors.store')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email"
                                                value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(trans('labels.email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label>Select Stockiest</label>
                                             <select class="form-control" name="stockiest_id">
                                                <option value="">Select Stockiest</option>
                                                <?php $__currentLoopData = $stockiest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($row->id); ?>"><?php echo e($row->stock_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                             </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Referral Code</label>
                                            <input type="text" class="form-control" oninput="checkRefer(this)" id="vendor-ref-code" name="vendor_ref_code"
                                                placeholder="Type referral Code">
                                            <?php $__errorArgs = ['vendor_ref_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            ...
                                            <div class="input-group m-0">
                                                <div class="input-group-prepend col-md-3 float-left pl-0">
                                                    <select class="form-control" name="country" data-show-subtext="true"
                                                        ...
                                                        <option data-countryCode="BD" value="880" selected>Bangladesh
                                                            (+880)</option>
                                                        ...
                                                        <option data-countryCode="VG" value="1">Virgin Islands -
                                                            British (+1)</option>
                                                        <option data-countryCode="VI" value="1">Virgin Islands - US
                                                            (+1)</option>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-actions center">
                                        ...
                                        <button id="save-btn" type="submit" class="btn btn-raised btn-primary">
...
<script>
    ...
    // $('#vendor-ref-code').on('change', function(e) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/vendors/add.blade.php ENDPATH**/ ?>