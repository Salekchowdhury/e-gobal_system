                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="woo_pr_detail">
                        ...
                        <div class="woo_cats_wrps">
                            <a href="#" class="woo_pr_cats"><?php echo e($product->category_name); ?> |
                                <?php echo e($product->subcategory_name); ?> | <?php echo e($product->innersubcategory_name); ?></a>
                        </div>
                            ...
                            <div class="woo_pr_offer_price">
                                <h3>
                                    ...
                                    <span class="org_price">
                                        ...
                                        <?php else: ?>
                                            <?php echo e(Helper::CurrencyFormatter($product->discounted_price)); ?>
                            ...
                            <?php else: ?>
                                <?php if($product->tax_type == 'percent'): ?>
                                    <span class="text-danger"><span
                                            id="additional_tax"><?php echo e(Helper::CurrencyFormatter(($product->product_price * $product->tax) / 100)); ?></span>
                                        <?php echo e(trans('labels.additional_tax')); ?></span>
                                <?php else: ?>
                                    <span class="text-danger"><span
                                            id="additional_tax"><?php echo e(Helper::CurrencyFormatter((float) $product->tax)); ?></span>
                                        <?php echo e(trans('labels.additional_tax')); ?></span>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                                ...
                                <div class="woo_colors_list pl-3">
                                    <?php $__currentLoopData = $product['variations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $variations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="custom-varient custom-size">
                                            <input type="radio" class="custom-control-input-details" name="variations"
                                                id="variation-<?php echo e($variations->id); ?>" value="<?php echo e($variations->id); ?>"
                                                price="<?php echo e($variations->price); ?>"
                                                variation-name="<?php echo e($variations->variation); ?>" qty="<?php echo e($variations->qty); ?>"
                                                old-price="<?php echo e($variations->discounted_variation_price); ?>"
                                                <?php if($key == 0): ?> checked <?php endif; ?>>
                                            <label class="custom-control-label"
                                                for="variation-<?php echo e($variations->id); ?>"><?php echo e($variations->variation); ?></label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        ...
                        <div class="cart_sku_preflix">
                            ...
                            <div class="sku_preflix_last">
                                <a href="<?php echo e(URL::to('vendor-details/' . $vendors->id)); ?>"
                                    class="woo_pr_cats"><?php echo e($vendors->name); ?> <br>
                    ...
                    <div class="woo_btn_action">
                        <div class="col-6 col-lg-auto">
                            <?php if(@Auth::user()->id != ''): ?>
                                ...
                                <?php if($product->is_variation == 0): ?>
                                    <?php if($product->product_qty > 0): ?>
                                        <button class="btn btn-block btn-dark mb-2 cart"
                                            onclick="AddtoCart()"><?php echo e(trans('labels.add_cart')); ?> <i
                                                class="ti-shopping-cart-full ml-2"></i></button>
                                    <?php else: ?>
                                        <button class="btn btn-block btn-dark mb-2 cart" disabled
                                            onclick="AddtoCart()"><?php echo e(trans('labels.add_cart')); ?> <i
                                                class="ti-shopping-cart-full ml-2"></i></button>
                                    <?php endif; ?>
                                <?php endif; ?>
                        ...
                        <?php else: ?>
                            <a class="btn btn-block btn-dark mb-2"
                                href="<?php echo e(URL::to('/signin')); ?>"><?php echo e(trans('labels.add_cart')); ?> <i
                                    class="ti-shopping-cart-full ml-2"></i></a>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-6 col-lg-auto">
                        <?php if($product->is_wishlist == 1): ?>
                            <button
                                onclick="RemoveWishList('<?php echo e($product->id); ?>','<?php echo e($product->product_name); ?>','<?php echo e(@Auth::user()->id); ?>')"
                                class="btn btn-gray btn-block mb-2"><?php echo e(trans('labels.wishlist')); ?> <i
                                    class="fas fa-heart i ml-2"></i></button>
                        <?php else: ?>
                            <button
                                onclick="WishList('<?php echo e($product->id); ?>','<?php echo e($product->product_name); ?>','<?php echo e(@Auth::user()->id); ?>')"
                                class="btn btn-gray btn-block mb-2"><?php echo e(trans('labels.wishlist')); ?> <i
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description"
                            ...
                            aria-expanded="true"><?php echo e(trans('labels.description')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="reviews-tab" data-toggle="tab" href="#reviews" role="tab"
                            aria-controls="reviews" aria-selected="false"
                            aria-expanded="false"><?php echo e(trans('labels.reviews')); ?></a>
                    </li>
                    <?php if($product->is_return == 1): ?>
                        <li class="nav-item">
                            <a class="nav-link" id="return-tab" data-toggle="tab" href="#return" role="tab"
                                ...
                                aria-expanded="false"><?php echo e(trans('labels.return-policy')); ?></a>
                        </li>
                    <?php endif; ?>
                </ul>
                    ...
                    <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab"
                        ...
                        <div class="review-wrapper">
                            <div class="review-wrapper-header">
                                <h4><?php echo e(count($product->products->reviews)); ?> Reviews</h4>
                            </div>
                            <div class="review-wrapper-body">
                                <ul class="review-list">

                                    <?php $__currentLoopData = $product->products->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="reviews-box">
                                                <div class="review-body">
                                                    <div class="review-avatar">
                                                        <img alt=""
                                                            src="<?php echo e($review->users->image_url); ?>"
                                                        ...
                                                        <div class="review-info">
                                                            <div class="review-comment">
                                                                <div class="review-author">
                                                                    <?php echo e($review->users->name); ?>

                                                                </div>

                                                                <div class="review-comment-stars">
                                                                    <?php if($review->ratting < 2): ?>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                    <?php elseif($review->ratting < 3): ?>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                    <?php elseif($review->ratting < 4): ?>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                    <?php elseif($review->ratting < 5): ?>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star empty"></i>
                                                                    <?php elseif($review->ratting < 6): ?>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
                                                                        <i class="fa fa-star"></i>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="owl-carousel products-slider owl-theme">
                <?php
                $strings = ['#FDF7FF', '#FDF3F0', '#EDF7FD', '#FFFAEA', '#F1FFF6'];
                $count = count($strings);
                ?>
                <!-- Single Item -->
                        ...
                        <div class="woo_product_grid no-hover">
                            <a href="<?php echo e(URL::to('products/product-details/' . @$products['slug'])); ?>">
                                <div class="woo_product_thumb">
                                    ...
                                    ?>
                                    <?php if($ext == 'png'): ?>
                                        <img src="<?php echo e($products['productimage']->image_url); ?>" class="img-fluid"
                                            alt=""
                                            style="height: 335px; object-fit: scale-down; background-color: #f8f7f6;"
                                            title="<?php echo e($products['product_name']); ?>" />
                                    <?php else: ?>
                                        <img src="<?php echo e($products['productimage']->image_url); ?>" class="img-fluid"
                                            alt="" style="height: 335px; object-fit: scale-down;"
                                            title="<?php echo e($products['product_name']); ?>" />
                                    <?php endif; ?>
                                ...
                                <div class="woo_product_caption">
                                    <div class="woo_title mt-2">
                                        ...
                                        <h6><i class="fa fa-star filled"></i>
                                            <?php echo e(number_format($products->ratings_average, 1)); ?></h6>
                                    </div>

                                    <div class="woo_price mt-2">
                                        <h6><?php echo e(Helper::CurrencyFormatter($products->product_price)); ?><span
                                                class="less_price"><?php echo e(Helper::CurrencyFormatter($products->discounted_price)); ?></span>
                                        </h6>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <?php if($product->product_price): ?>
                                        <span class="btn btn-sm btn-primary mt-2">Save
                                            <?php echo e(Helper::CurrencyFormatter($product->product_price - $product->discounted_price)); ?></span>
                                    <?php endif; ?>
                                </div>
                                <div class="col-7 mt-2">
                                    <button value="<?php echo e(URL::to('products/add-to-cart/' . $product->slug)); ?>"
                                        class="btn btn-sm btn-info" onclick="direct_add_to_cart(this)">Add to Cart</button>
                                </div>
                                <div class="col-5 mt-2">
                                    <button value="<?php echo e(URL::to('products/add-to-cart/' . $product->slug)); ?>"
                                        class="btn btn-sm btn-danger buy_now" onclick="buyNow(this)">Buy</button>
                                </div>
                            </div>
                                ...
                                <ul>
                                    <?php if($products->is_wishlist == 1): ?>
                                        <li><a href="javascript:void();"
                                                onclick="RemoveWishList('<?php echo e($products->id); ?>','<?php echo e($products->product_name); ?>','<?php echo e(@Auth::user()->id); ?>')"
                                                class="woo_cart_btn btn_save"><?php echo e(trans('labels.wishlist')); ?> <i
                                                    class="fas fa-heart i ml-2"></i></a></li>
                                    <?php else: ?>
                                        <li><a href="javascript:void();"
                                                onclick="WishList('<?php echo e($products->id); ?>','<?php echo e($products->product_name); ?>','<?php echo e(@Auth::user()->id); ?>')"
                                                class="woo_cart_btn btn_save"><?php echo e(trans('labels.wishlist')); ?> <i
                                                    class="ti-heart ml-2"></i></a></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </div>
    ...
    <input type="hidden" name="vendor_product_id" id="vendor_product_id" value="<?php echo e($product->id); ?>">
    ...
    <input type="hidden" name="point" id="point" value="<?php echo e($product->products->point); ?>">
    <input type="hidden" name="attribute" id="attribute" value="<?php echo e($product->attribute); ?>">
    <input type="hidden" name="product_qty" id="product_qty" value="<?php echo e($product->product_qty); ?>">
    <input type="hidden" name="product_type" id="product_type" value="<?php echo e($product->product_type); ?>">
    <?php $__currentLoopData = $product['productimages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<input type="hidden" name="admin_product_price" id="admin_product_price" value="<?php echo e($product->admin_product_price); ?>">

<?php if($product->tax_type == 'percent'): ?>
    <input type="hidden" name="tax_amount" id="tax_amount"
        value="<?php echo e(($product->product_price * $product->tax) / 100); ?>">
<?php else: ?>
...
<input type="hidden" name="currency_position" id="currency_position"
    value="<?php echo e($currency->currency_position); ?>">
...
<script type="text/javascript">
        ...
        if (tax != 0) {
            if (tax_type == 'percent') {
                ...
                if (currency_position == "left") {
                    $('#additional_tax').text(currency + parseFloat($(this).attr('price') * tax / 100).toFixed(
                        2));
                }
                if (currency_position == "right") {
                    $('#additional_tax').text(parseFloat($(this).attr('price') * tax / 100).toFixed(2) +
                        currency);
                }
            } else {
    ...
    function AddtoCart() {
        ...
        var admin_product_price = $('#admin_product_price').val();
console.log('admin_product_price is ', admin_product_price)
        $('#preloader').show();
        $.ajax({
            headers: {
            ...
            success: function(response) {
                localStorage.getItem('buynow') ? "" : $("#preloader").hide();
