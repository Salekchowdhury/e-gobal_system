    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li data-target="#carouselExampleIndicators" data-slide-to="<?php echo e($key1); ?>" class="<?php if ($key1 == 0) {
                    echo 'active';
                } ?>">
                </li>
        ...
        <div class="carousel-inner">
            <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="carousel-item <?php if ($key2 == 0) {
                    echo 'active';
                } ?>">
                            ...
                            <div class="card card_big">
                                <div class="card-bg">
                                    ...
                                    <div class="card-bg-img bg-cover"
                                        style="background:#fde9ed url('<?php echo e(Helper::image_path($value['image'])); ?>');"></div>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="sec-heading-flex pl-2 pr-2">
                        ...
                        <div class="sec-heading-flex-last">
                            <a href="<?php echo e(URL::to('/featured-products')); ?>"
                                class="btn btn-theme"><?php echo e(trans('labels.view_more')); ?><i
                        ...
                        <div class="woo_product_grid no-hover">
                            ...
                            <a href="<?php echo e(URL::to('products/product-details/' . $product->slug)); ?>">
                                <div class="woo_product_thumb">
                                    ...
                                    ?>
                                    <img src="<?php echo e($product['productimage']->image_url); ?>"
                                        class="img-fluid lazyload product-box-image <?php if($ext == 'png'): ?> gray-bg <?php endif; ?>"
                                        title="<?php echo e($product->product_name); ?>" />
                                ...
                                <div class="woo_product_caption">
                                    <div class="woo_title mt-2">
                                        ...
                                        <h6><i class="fa fa-star filled"></i>
                                            <?php echo e(number_format($product->ratings_average, 1)); ?></h6>
                                    </div>

                                    <div class="woo_price mt-2">
                                        <h6><?php echo e(Helper::CurrencyFormatter($product->product_price)); ?><span
                                                class="less_price"><?php echo e(Helper::CurrencyFormatter($product->discounted_price)); ?></span>
                                        </h6>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <?php if($product->product_price): ?>
                                        <span class="btn btn-sm btn-primary mt-2"><?php echo e(trans('labels.save')); ?>
                                ...
                                <div class="col-7 mt-2">
                                    <button value="<?php echo e(URL::to('products/add-to-cart/' . $product->slug)); ?>"
                                        class="btn btn-sm btn-info" onclick="add_to_cart(this)">Add to Cart</button>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="sec-heading-flex pl-2 pr-2">
                        ...
                        <div class="sec-heading-flex-last">
                            <a href="<?php echo e(URL::to('/hot-products')); ?>"
                                class="btn btn-theme"><?php echo e(trans('labels.view_more')); ?><i
                                    class="ti-arrow-right ml-2"></i></a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="sec-heading-flex pl-2 pr-2">
                        ...
                        <div class="sec-heading-flex-last">
                            <a href="<?php echo e(URL::to('/new-products')); ?>"
                                class="btn btn-theme"><?php echo e(trans('labels.view_more')); ?><i
                                    class="ti-arrow-right ml-2"></i></a>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="sec-heading-flex pl-2 pr-2">
                    ...
                    <div class="sec-heading-flex-last">
                        <a href="<?php echo e(URL::to('/all-brand')); ?>"
                            class="btn btn-theme"><?php echo e(trans('labels.view_more')); ?><i
                                class="ti-arrow-right ml-2"></i></a>
                    </div>
                </div>
                        ...
                        <div class="item">
                            <div class="woo_category_box border_style circle">
                                <div class="woo_cat_thumb">
                                    <a href="<?php echo e(URL::to('brands/' . $value->id)); ?>"><img
                                            src="<?php echo e(Helper::image_path($value['icon'])); ?>" class="img-fluid" /></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="sec-heading-flex pl-2 pr-2">
                    ...
                    <div class="sec-heading-flex-last">
                        <a href="<?php echo e(URL::to('/all-vendors')); ?>"
                            class="btn btn-theme"><?php echo e(trans('labels.view_more')); ?><i
                                class="ti-arrow-right ml-2"></i></a>
                    </div>
                </div>
                ...
                <div class="owl-carousel products-slider owl-theme">
                    ...
                    <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key10 => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="item">
                            <div class="woo_product_grid no-hover">
                                <div class="woo_product_thumb">
                                    <img src="<?php echo e(Helper::image_path($list->profile_pic)); ?>"
                                        class="img-fluid lazyload vendor-box-image" />
                                ...
                                <div class="woo_product_caption center">
                                    <div class="woo_title mt-3">
                                        <h4 class="woo_pro_title"><a
                                                href="<?php echo e(URL::to('vendor-details/' . $list->id)); ?>"><?php echo e($list->name); ?></a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
