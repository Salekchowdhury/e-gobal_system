                    ...
                    <div class="col-12">
                        ...
                        <div class="card shadow-2-strong" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <form action="<?php echo e(url('admin/bank_list/update')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="py-1 col-10">
                                            
                                            <input type="text" id="" value="<?php echo e($data->name); ?>" required
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/bank/show.blade.php ENDPATH**/ ?>