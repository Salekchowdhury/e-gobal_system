...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="delivery_charge"><?php echo e(trans('Delivery Charge')); ?></label>
                                            <div class="col-md-9">
                                                <input type="number" name="delivery_charge" class="form-control" placeholder="<?php echo e(trans('labels.delivery_charge')); ?>" value="<?php echo e($data->delivery_charge); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="sales_center_commission"><?php echo e(trans('sales center commission')); ?></label>
                                            <div class="col-md-9">
                                                <input type="number" name="sales_center_commission" class="form-control" placeholder="<?php echo e(trans('labels.sales_center_commission')); ?>" value="<?php echo e($data->sales_center_commission); ?>">
                                                <?php $__errorArgs = ['sales_center_commission'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="text-danger"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="sales_center_commission"><?php echo e(trans('distribute amount')); ?></label>
                                            <div class="col-md-9">
                                                <input type="number" name="distribute_amount" class="form-control" placeholder="<?php echo e(trans('labels.distribute_amount')); ?>" value="<?php echo e($data->distribute_amount); ?>">
                                                <?php $__errorArgs = ['distribute_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="text-danger"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="pt_value"><?php echo e(trans('pt Value')); ?></label>
                                            <div class="col-md-9">
                                                <input type="number" name="pt_value" class="form-control" placeholder="<?php echo e(trans('labels.pt_value')); ?>" value="<?php echo e($data->pt_value); ?>">
                                                <?php $__errorArgs = ['pt_value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="text-danger"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                         ...
                                         <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="withdraw_charge"><?php echo e(trans('withdraw charge')); ?></label>
                                            <div class="col-md-9">
                                                <input type="number" name="withdraw_charge" class="form-control" placeholder="<?php echo e(trans('labels.withdraw_charge')); ?>" value="<?php echo e($data->withdraw_charge); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/settings/index.blade.php ENDPATH**/ ?>