...
unset($__errorArgs, $__bag); ?>
					...
					<h4 class="mt-3"><?php echo e(trans('labels.sales_point')); ?></h4>

                    <div class="mb-3">
                        <select id="stock" type="text"  name="stock_name"
                        class="form-control">
                        <option>Please Select Stock ....</option>
                        <?php $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($stock->id); ?>"><?php echo e($stock->stock_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    </div>
                    <p class="sales-point-error text-danger"></p>
...
let stockId = ''
    ...
    $('select').change(function() {
        var stock_id = $("#stock option:selected").attr('value');
        // alert(stock_id);
        stockId= stock_id;
    });
	...
	function Order()
	{
        ...
        // return;
        if(stockId == ''){
          document.querySelector(".sales-point-error").innerHTML = "Please Select Sales Point";
          document.querySelector(".sales-point-error").style.display = "block";
        }
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Front/checkout.blade.php ENDPATH**/ ?>