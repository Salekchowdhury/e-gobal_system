...
unset($__errorArgs, $__bag); ?>
							    ...
							    <div class="col-lg-12 col-md-12">
							    	<div class="form-group">
							    		<input type="text" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');"  minlength="10" maxlength="10" name="mobile" id="mobile" placeholder="<?php echo e(trans('labels.mobile')); ?>">
