											...
											<li class="complete">
												<div class="trach_single_list">
													...
													<div class="track_list_caption">
                                                        ...
                                                        <span><?php echo e($comment->generate_date); ?><p><?php echo e(trans('labels.order_placed_text')); ?></p>
													</div>
												</div>
											</li>
											<li class="processing">
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Front/track-order.blade.php ENDPATH**/ ?>