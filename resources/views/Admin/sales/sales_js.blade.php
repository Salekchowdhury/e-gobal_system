<script type="text/javascript">
    ...
    //                     if (ele == {{ $product->id }} && ele ==id) {
    //                         productItem = 1;
    //                         itemHtml +=
    //                             `<option value="{{ $product->id }}" selected>{{ $product->product_name }}</option>`;

    //                     }else if (ele == {{ $product->id }}) {
    //                         productItem = 1;
    //                         itemHtml +=
    //                             `<option value="{{ $product->id }}" disabled>{{ $product->product_name }}</option>`;
    //                     }

    //                 })
    //                 if (productItem == 0) {
    //                     itemHtml += `<option value="{{ $product->id }}">{{ $product->product_name }}</option>`;
    //                 }
    //                 itemHtml += `
    //                             @endforeach
    //                         </select>
