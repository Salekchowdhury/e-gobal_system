    ...
    <footer>
        <div>
            <div>
                ...
                {{-- <p class="" style="font-size: 10px">Tel: +880-1813-316786, +880-1722-964303</p> --}}
            </div>
    ...
    <main>
        <div class="invoice-area">
            <div class="invoice-wrapper">
                ...
                <div>
                    <p class="thank-header mt-25" style="font-size: 20px">{{ $setting->address }}</p>
                </div>
                <div>
                    <p class="thank-header  mt-25" style="font-size: 20px">Phone:{{ $setting->contact }}</p>
                </div>
                <div>
                    <?php
                    ...
                    Sale Code: <span> </span> <span style="margin-left: 340px"> Invoice No :
                        <span>{{ $invoice_id }}</span></span><br>
                    Bill Date: <span>{{ $bill_date }}</span> <span style="margin-left: 50px">Time:
                        <span>{{ $currentDate }}</span></span>
                    <span style="margin-left: 128px">Creator Name: <span>{{ $auth_name }}</span></span>
                </div>
