                                ...
                                <div class="px-3">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control" id="product_name" name="product_name" placeholder="{{ trans('placeholder.product') }}" value="{{old('product_name')}}">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                        <input required type="text" class="form-control" id="sku" name="sku" placeholder="{{ trans('placeholder.sku') }}" value="{{old('sku')}}">
                                    ...
                                    <div class="form-group row">
                                      <label for="product_type" class="col-sm-2 col-form-label">{{ trans('labels.product_type') }}</label>
                                      <div class="col-sm-10">
...
$.ajax({
    url: "{{route('admin.add.product.search')}}",
    method: 'GET',
...
//   alert(product_id);
     ...
     $.ajax({
            url: "{{route('admin.products.searchById')}}",
            method: 'GET',
