                                        ...
                                        <div class="col-sm-10">
                                          <select class="form-control" name="product_type" required>
                                             {{-- {{dd($data)}} --}}
                                              ...
                                              <option  value="own_product" {{$data->product_type == 'own_product' ? 'selected' : '' }}>Own Product </option>
                                              <option value="stockiest_product" {{$data->product_type == 'stockiest_product' ? 'selected' : '' }} >Stockiest Product </option>
                                          </select>
