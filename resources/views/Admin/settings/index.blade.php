                            ...
                            <div class="px-3">
                                <form class="form form-horizontal striped-rows form-bordered" method="post" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="delivery_charge">{{trans('Delivery Charge')}}</label>
                                            <div class="col-md-9">
                                                <input type="number" name="delivery_charge" class="form-control" placeholder="{{ trans('labels.delivery_charge') }}" value="{{$data->delivery_charge}}">
                                                @error('delivery_charge')<span class="text-danger">{{ $message }}</span>@enderror
                                            </div>
                                        </div>
                                        <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="sales_center_commission">{{trans('sales center commission')}}</label>
                                            <div class="col-md-9">
                                                <input type="number" name="sales_center_commission" class="form-control" placeholder="{{ trans('labels.sales_center_commission') }}" value="{{$data->sales_center_commission}}">
                                                @error('sales_center_commission')<span class="text-danger">{{ $message }}</span>@enderror
                                            </div>
                                        </div>
                                        <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="sales_center_commission">{{trans('distribute amount')}}</label>
                                            <div class="col-md-9">
                                                <input type="number" name="distribute_amount" class="form-control" placeholder="{{ trans('labels.distribute_amount') }}" value="{{$data->distribute_amount}}">
                                                @error('distribute_amount')<span class="text-danger">{{ $message }}</span>@enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="pt_value">{{trans('pt Value')}}</label>
                                            <div class="col-md-9">
                                                <input type="number" name="pt_value" class="form-control" placeholder="{{ trans('labels.pt_value') }}" value="{{$data->pt_value}}">
                                                @error('pt_value')<span class="text-danger">{{ $message }}</span>@enderror
                                            </div>
                                        </div>

                                         <div class="form-group row last">
                                            <label class="col-md-3 label-control" for="withdraw_charge">{{trans('withdraw charge')}}</label>
                                            <div class="col-md-9">
                                                <input type="number" name="withdraw_charge" class="form-control" placeholder="{{ trans('labels.withdraw_charge') }}" value="{{$data->withdraw_charge}}">
                                                @error('withdraw_charge')<span class="text-danger">{{ $message }}</span>@enderror
                                            </div>
                                        </div>
