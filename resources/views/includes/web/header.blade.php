                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-8">
                    ...
                    <div class="topbar_menu">
                        <ul @if (session()->get('locale') == 'en' OR session()->get('locale') == '') style="float: right;" @endif>
                            <li class="hide-m"><a href="{{URL::to('account')}}"><i class="ti-user"></i>{{trans('labels.welcome')}} {{Auth::user()->name}} </a></li>
                    ...
                    <div class="topbar_menu">
                        <ul @if (session()->get('locale') == 'en' OR session()->get('locale') == '') style="float: right;" @endif>
                            ...
                            <li><a href="{{URL::to('signup')}}"><i class="ti-stamp"></i>{{trans('labels.signup')}}</a></li>
