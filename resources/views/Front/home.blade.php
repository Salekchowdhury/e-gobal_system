    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            @foreach ($sliders as $key1 => $slider)
                <li data-target="#carouselExampleIndicators" data-slide-to="{{ $key1 }}" class="<?php if ($key1 == 0) {
                    echo 'active';
                } ?>">
                </li>
            @endforeach
                            ...
                            <div class="card card_big">
                                <div class="card-bg">
                                    ...
                                    <div class="card-bg-img bg-cover"
                                        style="background:#fde9ed url('{{ Helper::image_path($value['image']) }}');"></div>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="sec-heading-flex pl-2 pr-2">
                        ...
                        <div class="sec-heading-flex-last">
                            <a href="{{ URL::to('/featured-products') }}"
                                class="btn btn-theme">{{ trans('labels.view_more') }}<i
                        ...
                        <div class="woo_product_grid no-hover">
                            ...
                            <a href="{{ URL::to('products/product-details/' . $product->slug) }}">
                                <div class="woo_product_thumb">
                                    ...
                                    ?>
                                    <img src="{{ $product['productimage']->image_url }}"
                                        class="img-fluid lazyload product-box-image @if ($ext == 'png') gray-bg @endif"
                                ...
                                <div class="woo_product_caption">
                                    <div class="woo_title mt-2">
                                        ...
                                        <h6><i class="fa fa-star filled"></i>
                                            {{ number_format($product->ratings_average, 1) }}</h6>
                                    </div>

                                    <div class="woo_price mt-2">
                                        <h6>{{ Helper::CurrencyFormatter($product->product_price) }}<span
                                                class="less_price">{{ Helper::CurrencyFormatter($product->discounted_price) }}</span>
                                        </h6>
                                    </div>

                                    {{-- @if ($product->product_price)
                                        <span class="post-article-cat theme-bg mt-2">{{ trans('labels.save') }}
                            ...
                            <div class="row">
                                <div class="col-12">
                                    @if ($product->product_price)
                                        <span class="btn btn-sm btn-primary mt-2">{{ trans('labels.save') }}
                                            {{ Helper::CurrencyFormatter($product->product_price - $product->discounted_price) }}</span>
                                    @endif
                                </div>
                        ...
                        <div class="item">
                            <div class="woo_category_box border_style circle">
                                <div class="woo_cat_thumb">
                                    <a href="{{ URL::to('brands/' . $value->id) }}"><img
                                            src="{{ Helper::image_path($value['icon']) }}" class="img-fluid" /></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="owl-carousel products-slider owl-theme">
                    ...
                    @foreach ($vendors as $key10 => $list)
                        ...
                        <div class="item">
                            <div class="woo_product_grid no-hover">
                                <div class="woo_product_thumb">
                                    <img src="{{ Helper::image_path($list->profile_pic) }}"
                                ...
                                <div class="woo_product_caption center">
                                    <div class="woo_title mt-3">
                                        <h4 class="woo_pro_title"><a
                                                href="{{ URL::to('vendor-details/' . $list->id) }}">{{ $list->name }}</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
